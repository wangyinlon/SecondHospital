...
namespace YinLong.Framework
{
    /// <summary>
    /// Http连接操作帮助类
    /// </summary>
    public class HttpHelperMin
    {
        #region 预定义方变量
        //默认的编码
        ...
        public HttpResultMin GetHtml(HttpItemMin item)
        {
            ...
            {
                //配置参数时出错
                return new HttpResultMin() { Cookie = string.Empty, Header = null, Html = ex.Message, StatusDescription = "配置参数时出错：" + ex.Message };
            }
            try
            {
                //请求数据
        ...
        {
            //是否返回Byte类型数据
            if (item.ResultType == ResultTypeMin.Byte) result.ResultByte = ResponseByte;
            //从这里开始我们要无视编码了
            if (encoding == null)
            {
    ...
    public class HttpItemMin
    {
        ...
        private PostDataTypeMin _PostDataType = PostDataTypeMin.String;
        /// <summary>
        /// Post的数据类型
        /// </summary>
        public PostDataTypeMin PostDataType
        {
        ...
        private ResultTypeMin resulttype = ResultTypeMin.String;
        /// <summary>
        /// 设置返回类型String和Byte
        /// </summary>
        public ResultTypeMin ResultType
        {
        ...
        private ResultCookieTypeMin _ResultCookieType = ResultCookieTypeMin.String;
        /// <summary>
        /// Cookie返回类型,默认的是只返回字符串类型
        /// </summary>
        public ResultCookieTypeMin ResultCookieType
        {
    ...
    /// Cookie返回类型
    /// </summary>
    public enum ResultCookieTypeMin
    {
        /// <summary>
        /// 只返回字符串类型的Cookie
        /// </summary>
