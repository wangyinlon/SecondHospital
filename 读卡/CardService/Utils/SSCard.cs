...
namespace CardService.Utils
{
    ...
    public class SSCard
    {
        ...
        [DllImport("dkSICARD.dll", EntryPoint = "getCardNO")]
        public static extern int getCardNO(int icdev, StringBuilder cardno,StringBuilder ierrinfo);

        [DllImport("dkSICARD.dll", EntryPoint = "iDOpenPort")]
        public static extern int iDOpenPort(int port,ref int com, StringBuilder ierrinfo);
        #endregion
        /// <summary>
        /// 读取社会保障号和姓名
        /// </summary>
